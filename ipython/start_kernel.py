...
def json_serial(obj):
  """JSON seriaizer for objects not serializable by default JSON code"""
...
def kernel(wd=None, verbose=0):
  ...
  kernel_client.execute("%run " + python_patch_file, {"store_history": False})
