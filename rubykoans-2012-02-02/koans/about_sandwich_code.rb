...
#$filename = File.expand_path(File.dirname(__FILE__) + '/example_file.txt')
...
class AboutSandwichCode < EdgeCase::Koan
  ...
  def test_counting_lines
    assert_equal 4, count_lines($filename)
  end
  ...
  def test_counting_lines2
    assert_equal 4, count_lines2($filename)
  end
  ...
  def test_open_handles_the_file_sandwich_when_given_a_block
    assert_equal 4, count_lines3($filename)
  end
