...
from server.comm.manager import CommManager
from server.kernel.base import Kernel as KernelBase
...
class MetaKernel(KernelBase):
  ...
  def __init__(self, **kwargs):
    super(MetaKernel, self).__init__(**kwargs)
  ...
  def set_parent(self, ident, parent):
    ...
    """
    super(MetaKernel, self).set_parent(ident, parent)
  ...
  def init_metadata(self, parent):
    ...
    """
    md = super(MetaKernel, self).init_metadata(parent)
